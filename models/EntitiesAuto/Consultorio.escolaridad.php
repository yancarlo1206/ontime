...
/**
 * Consultorio.escolaridad
 *
 * @Table(name="consultorio.escolaridad")
 * @Entity
 */
class Consultorio.escolaridad
{
...
function __construct() {}
     ...
     * @SequenceGenerator(sequenceName="consultorio.escolaridad_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
