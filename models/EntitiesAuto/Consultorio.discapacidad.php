...
/**
 * Consultorio.discapacidad
 *
 * @Table(name="consultorio.discapacidad")
 * @Entity
 */
class Consultorio.discapacidad
{
...
function __construct() {}
     ...
     * @SequenceGenerator(sequenceName="consultorio.discapacidad_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
