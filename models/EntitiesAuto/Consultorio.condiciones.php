...
/**
 * Consultorio.condiciones
 *
 * @Table(name="consultorio.condiciones")
 * @Entity
 */
class Consultorio.condiciones
{
...
function __construct() {}
     ...
     * @SequenceGenerator(sequenceName="consultorio.condiciones_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
