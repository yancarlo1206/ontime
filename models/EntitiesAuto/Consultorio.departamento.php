...
/**
 * Consultorio.departamento
 *
 * @Table(name="consultorio.departamento")
 * @Entity
 */
class Consultorio.departamento
{
...
function __construct() {}
     ...
     * @SequenceGenerator(sequenceName="consultorio.departamento_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
