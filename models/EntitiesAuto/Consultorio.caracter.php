...
/**
 * Consultorio.caracter
 *
 * @Table(name="consultorio.caracter")
 * @Entity
 */
class Consultorio.caracter
{
...
function __construct() {}
     ...
     * @SequenceGenerator(sequenceName="consultorio.caracter_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
