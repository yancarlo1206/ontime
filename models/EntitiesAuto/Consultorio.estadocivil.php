...
/**
 * Consultorio.estadocivil
 *
 * @Table(name="consultorio.estadocivil")
 * @Entity
 */
class Consultorio.estadocivil
{
...
function __construct() {}
     ...
     * @SequenceGenerator(sequenceName="consultorio.estadocivil_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
