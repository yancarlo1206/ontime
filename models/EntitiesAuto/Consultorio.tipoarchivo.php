...
/**
 * Consultorio.tipoarchivo
 *
 * @Table(name="consultorio.tipoarchivo")
 * @Entity
 */
class Consultorio.tipoarchivo
{
...
function __construct() {}
     ...
     * @SequenceGenerator(sequenceName="consultorio.tipoarchivo_id_seq", allocationSize=1, initialValue=1)
     */
    private $id;
