 ...
 * Mensaje
 *
 * @Table(name="mensaje", uniqueConstraints={@UniqueConstraint(name="fk_mensaje_usuario", columns={"usuario"})}, indexes={@Index(name="IXFK_mensaje_dosificacion", columns={"dosis"}), @Index(name="fk_mensaje_estadomensaje1_idx", columns={"estadomensaje"})})
 * @Entity
 */
class Mensaje
{
