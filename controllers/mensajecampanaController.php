...
class mensajecampanaController extends Controller
{   
    ...
    private function obj($new = true) {
        $arrayTexto = array('mensaje','fechaEnvio');
        $arrayInt = array('telefono');
        ...
        $this->_model->getInstance()->setCampana('campana');

        $this->_model->getInstance()->setTelefono($this->getInt('telefono'));
        $this->_model->getInstance()->setMensaje($this->getTexto('mensaje'));
        $this->_model->getInstance()->setFechaEnvio(new \DateTime($this->getTexto('fechaEnvio')));

        $this->_model->getInstance()->setFechaProgramada(new \DateTime());
